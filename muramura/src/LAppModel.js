				...
				thisRef.loadTexture(i, texPaths, function() {
					...
					if (thisRef.isTexLoaded) {
						...
						if (thisRef.modelSetting.getLayout() != null) {
							...
							var mat = thisRef.modelMatrix;
							if (layout["width"] != null)
								mat.setWidth(layout["width"]);
							if (layout["height"] != null)
								mat.setHeight(layout["height"]);
							if (layout["x"] != null)
								mat.setX(layout["x"]);
							if (layout["y"] != null)
								mat.setY(layout["y"]);
							if (layout["center_x"] != null)
								mat.centerX(layout["center_x"]);
							if (layout["center_y"] != null)
								mat.centerY(layout["center_y"]);
							if (layout["top"] != null)
								mat.top(layout["top"]);
							if (layout["bottom"] != null)
								mat.bottom(layout["bottom"]);
							if (layout["left"] != null)
								mat.left(layout["left"]);
							if (layout["right"] != null)
								mat.right(layout["right"]);
						}
